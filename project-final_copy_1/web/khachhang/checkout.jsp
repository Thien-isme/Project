                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="row justify-content-between">
                                                        ...
                                                        <div class="media-body my-auto">
                                                            <div class="row ">
                                                                <div class="col-auto">
                                                                    ...
                                                                    <input  value="<%=sp.getMasanpham()%>" name="sanpham<%=i%>">
                                                                    <input  value="<%=gioHang1.getSize()%>" name="sizesanpham<%=i%>">
                                                                    <h1>sanpham<%=i%></h1>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class=" pl-0 flex-sm-col col-auto my-auto">
                                                    ...
                                                    <input  value="<%=gioHang1.getSoluong()%>" name="soluongsanpham<%=i%>">
                                                </div>
                                                <div class=" pl-0 flex-sm-col col-auto my-auto ">
                                                    <p><b><%=priceTemp%> </b></p>
                                                    <input  value="<%=priceTemp%>" name="giatiensanpham<%=i%>">
                                                    <%
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="flex-sm-col col-auto">
                                                                ...
                                                                <input style="color: red " type="hidden" name="total" value="<%=subtotal + 30000.0%>">dfsdf
                                                            </div>
                                                        </div>
                                                        <hr class="my-0">
                                                    </div>
